    ...
    >
      <div className="bg-primary overflow-hidden flex items-stretch h-full">
        ...
        <div className="p-[14px] flex flex-col justify-center flex-1 min-w-0">
          <p className="text-label-sm uppercase text-white mb-[4px]">
            Free on the App Store
          </p>
          <p className="text-title-sm text-white mb-[8px]">
            Get the Reetle iOS app
          </p>
          <div className="flex items-center gap-[6px] text-label-md text-white group-hover:text-white/80 transition-colors">
