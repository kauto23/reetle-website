...
const badgeVariants = cva(
  'inline-flex items-center border px-2.5 py-0.5 text-label-sm uppercase transition-colors focus:outline-none focus:ring-2 focus:ring-ui-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        default:
